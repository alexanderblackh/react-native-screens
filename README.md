...
1) The override code should not be placed inside `MainActivityDelegate`, but rather directly in `MainActivity`. 
2) If your MainActivity looks different, than the following simply put the code early in the MainActivity class AND include the import statement.
